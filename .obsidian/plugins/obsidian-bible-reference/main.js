...
var BibleReferenceSettingTab = class extends import_obsidian.PluginSettingTab {
  constructor(app, plugin) {
    ...
    this.SetUpBibleTagging = (containerEl) => {
      new import_obsidian.Setting(containerEl).setName("Create Bible Tags").setDesc("Makes hidden #bible tag").addToggle(
        (toggle) => {
          var _a;
    ...
    this.SetUpBookTagging = (containerEl) => {
      new import_obsidian.Setting(containerEl).setName("Create Book Tags").setDesc("Makes hidden #{book} tag").addToggle(
        (toggle) => {
          var _a;
    ...
    this.SetUpChapterTagging = (containerEl) => {
      new import_obsidian.Setting(containerEl).setName("Create Chapter Tags").setDesc("Makes hidden #{book_chapter} tag").addToggle(
        (toggle) => {
          var _a;
    ...
    this.SetUpBookBacklinking = (containerEl) => {
      new import_obsidian.Setting(containerEl).setName("Create Book Backlink").setDesc("Makes [[{book}]] link").addToggle(
        (toggle) => {
          var _a;
    ...
    this.SetUpChapterBacklinking = (containerEl) => {
      new import_obsidian.Setting(containerEl).setName("Create Chapter Backlink").setDesc("Makes [[{book_chapter}]] link").addToggle(
        (toggle) => {
          var _a;
